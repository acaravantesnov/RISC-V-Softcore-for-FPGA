...
package body ControlUnitPkg is
  ...
  begin
    case instruction(6 downto 0) is
      ...
      when "0110111" => microcode := "000000011011001000001100"; -- U-type lui
      ...
      when "0000011" => -- I-type Loads
        case instruction(14 downto 12) is
          when "000"	=> microcode := "000000000000001000000001"; -- lb
          when "001"	=> microcode := "000000000000001000000011"; -- lh
          when "010"	=> microcode := "000000000000001000000101"; -- lw
          when "100"	=> microcode := "000000000000001000000000"; -- lbu
          when "101"	=> microcode := "000000000000001000000010"; -- lhu
        ...
        case instruction(14 downto 12) is
          when "000" => -- beq
          	if (comparison = "000") then -- rs1 == rs2
          		microcode := "000000001001000101000100";
          	else -- rs1 != rs2
          		microcode := "000000001001000100000100";
          	end if;
          when "001" => -- bne
          	if (comparison = "000") then -- rs1 == rs2
          		microcode := "000000001001000100000100";
          ...
          when "100" => -- blt
            if (comparison = "001") then -- rs1 < rs2
              microcode := "000000001001000001000100";
            else -- rs1 >= rs2
              microcode := "000000001001000000000100";
            end if;
          when "101" => -- bge
