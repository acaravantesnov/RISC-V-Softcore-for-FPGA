...
{
	iki_relocate(dp, "xsim.dir/RISCV_CPU_TB_behav/xsim.reloc",  (void **)funcTab, 16);
	iki_vhdl_file_variable_register(dp + 4206184);
	iki_vhdl_file_variable_register(dp + 4206240);
